...
app.get('/api/oraculo-chat/:clientId', async (req: Request, res: Response) => {
  try {
    ...
    try {
      ...
      console.warn('[OraculoChat] Query error:', e);
    }
...
app.post('/api/oraculo-chat', async (req: Request, res: Response) => {
  try {
    ...
    try {
      ...
      console.warn('[OraculoChat] Insert error:', e);
    }
...
/**
 * GET /api/oraculo-memoria/:clientId - Recupera histórico da memória do Oráculo
 */
