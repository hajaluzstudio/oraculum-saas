...
-- 3. Adicionar a coluna agency_id nas tabelas existentes para isolamento
DO $$ 
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='niche_knowledge_base' AND column_name='agency_id') THEN
